...
<!-- End Main Sectio -->
      ...
      id="footer-start">
        <div class="row" >
          ...
          <div class="col-md-4" id="about"><div class="brand ">
        ...
        <div class="icon"><i class="fa-brands fa-facebook"></i>
          ...
          <div class="col-md-4 link" id="links"><h3>Quick Links</h3>
          <a href="#">1. Why Us</a>
          <a href="#">2. Affiliate Program</a>
          <a href="#">3. Join Us</a>

        </div>
        <div class="col-md-4" id="links"><h3>Pages</h3>
      ...
      <div class="footer"><p><i class="fa-solid fa-copyright"></i>All Right CopyRigth Reserved EasyBusinessSurvey.Com</p></div>
